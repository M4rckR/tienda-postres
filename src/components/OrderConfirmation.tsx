...
export const OrderConfirmation = () => {
  ...
  const handleConfirmOrder = useDessertStore((state) => state.handleConfirmOrder);
  const processOrder = useDessertStore((state) => state.processOrder);
              ...
              <div className="absolute bg-white p-8 rounded-2xl top-10 left-1/2 -translate-x-1/2 min-w-[90%] md:min-w-[500px] shadow max-h-[90vh] overflow-y-auto">
                ...
                <div className="bg-m-Rose50 px-6 py-2">
                  {dessertCart.map((item) => (
                    <div key={item.id} className="flex items-center py-4 justify-between border-b border-m-Rose100">
